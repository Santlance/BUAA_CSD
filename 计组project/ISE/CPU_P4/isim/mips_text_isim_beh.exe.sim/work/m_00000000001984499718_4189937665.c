...
#endif
static const char *ng0 = "C:/Users/asus/Desktop/ISE/CPU_P4/MuxRegRd.v";
...
LAB9:    memcpy(t145, t4, 8);

LAB10:    memset(t173, 0, 8);
    t174 = (t145 + 4);
...
LAB56:    t382 = (t0 + 4312);
    ...
    *((unsigned int *)t386) = (t393 | t387);
    t394 = *((unsigned int *)t392);
    *((unsigned int *)t392) = (t394 | t388);
    xsi_driver_vfirst_trans(t382, 0, 0U);
    t395 = (t0 + 4216);
    *((int *)t395) = 1;
...
LAB30:    memcpy(t105, t67, 8);

LAB31:    memset(t137, 0, 8);
    t138 = (t105 + 4);
...
LAB88:    memcpy(t314, t276, 8);

LAB89:    memset(t346, 0, 8);
    t347 = (t314 + 4);
...
LAB102:    if (*((unsigned int *)t347) != 0)
        goto LAB103;

LAB104:    t355 = *((unsigned int *)t173);
...
LAB77:    if (*((unsigned int *)t237) != 0)
        goto LAB78;

LAB79:    t245 = *((unsigned int *)t205);
...
LAB70:    *((unsigned int *)t217) = 1;
    goto LAB73;

LAB75:    t230 = *((unsigned int *)t217);
...
LAB91:    *((unsigned int *)t290) = 1;

LAB93:    memset(t306, 0, 8);
    t307 = (t290 + 4);
...
LAB95:    if (*((unsigned int *)t307) != 0)
        goto LAB96;

LAB97:    t315 = *((unsigned int *)t276);
...
LAB39:    xsi_vlog_unsigned_bit_combine(t21, 32, t87, 32, t93, 32);
    goto LAB43;

LAB41:    memcpy(t21, t87, 8);
    goto LAB43;

}


extern void work_m_00000000001984499718_4189937665_init()
{
	static char *pe[] = {(void *)NetDecl_29_0,(void *)Cont_30_1};
	xsi_register_didat("work_m_00000000001984499718_4189937665", "isim/mips_text_isim_beh.exe.sim/work/m_00000000001984499718_4189937665.didat");
